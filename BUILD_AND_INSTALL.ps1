...
$TempDir = Join-Path $env:TEMP ("ErenshorJournal-build-" + [Guid]::NewGuid().ToString("N"))
New-Item -ItemType Directory -Force -Path $TempDir | Out-Null
$TempDll = Join-Path $TempDir "ErenshorJournal.dll"
$rsp = Join-Path $TempDir "ErenshorJournal.rsp"
$out = Join-Path $pluginRoot "ErenshorJournal.dll"
...
try {
    ...
    Write-Host "Building Erenshor Journal as a native Lunaris plugin..." -ForegroundColor Cyan
